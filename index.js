...
var api = new ParseServer({
  ...
  serverURL: process.env.SERVER_URL || 'https://secret-coast-59488.herokuapp.com/parse/',  // Don't forget to change to https if needed
  liveQuery: {
  ...
  publicServerURL: 'https://secret-coast-59488.herokuapp.com/parse/',
  appName: 'WiiBeast',
});
