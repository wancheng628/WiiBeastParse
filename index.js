...
var api = new ParseServer({
  ...
  serverURL: process.env.SERVER_URL || 'http://wiibeastparse.herokuapp.com/parse/',  // Don't forget to change to https if needed
  liveQuery: {
  ...
  publicServerURL: 'http://wiibeastparse.herokuapp.com/parse/',
  appName: 'WiiBeast',
});
